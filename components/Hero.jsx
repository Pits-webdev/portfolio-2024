  ...
  return (
    <section className='w-full h-screen -z-[10]'>
      ...
      <div className='absolute top-0 left-0 w-full h-screen'>
        <div className='mx-auto w-full h-full grid grid-cols-5 grid-rows-5 '>
          <span
         ...
         h-[1px] col-start-1 col-end-6 row-start-5 '
          ...
          <div className='col-start-3 col-end-4 row-start-5 mx-auto flex justify-center items-center z-20'>
